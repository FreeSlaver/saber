/* @Date: Sat Dec 09 2017 18:09:00 GMT+0800 (中国标准时间)

 */
!function () {
    function e() {
        if ("ActiveXObject" in window) t = "ie"; else if (r.indexOf("firefox") > -1) t = "firefox"; else if (r.indexOf("opera") > -1 || r.indexOf("opr") > -1) t = "opera"; else if (r.indexOf("safari") > -1 && -1 == r.indexOf("chrome")) t = "safari"; else if (r.indexOf("chrome") > -1) {
            var e = i();
    ...
    function n(e) {
        document.addEventListener("gwd_extension", function (i) {
            if ("get_btype" === i.detail.type) {
                ...
                n.initCustomEvent("gwd_content", !0, !0, {type: "get_btype", value: e}), document.dispatchEvent(n)
            }
        })
    }
    ...
    var r = navigator.userAgent.toLowerCase(), t = "", a = {
        result: "Chrome",
        details: {Chrome: 5, Chromium: 0, _360SE: 0, _360EE: 0},
        sorted: ["Chrome", "360SE", "360EE", "Chromium"],
        exec: function (e) {
            var i = {Chrome: 5, Chromium: 0, _360SE: 0, _360EE: 0}, n = window.navigator.userAgent;
            if (/Chrome\/([\d.])+\sSafari\/([\d.])+$/.test(n)) {
                ...
                var t, a = 0;
                for (var r in window.navigator.plugins)if (t = /^(.+) PDF Viewer$/.exec(window.navigator.plugins[r].name)) {
                    if ("Chrome" == t[1]) {
