...
import com.song.sojob.crawler4j.processor.LagouPageProcessor;
 ...
 */
public class LagouCrawler extends WebCrawler {
    private static final Logger logger = LoggerFactory.getLogger(LagouCrawler.class);
